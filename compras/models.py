...
class Compra(models.Model):
    ...
    profile=models.ForeignKey(Profile, related_name='data_profile' on_delete=True)

    #telephone=models.CharField(max_length=20, requiered=True)

    #data of purchase
    shippingAddres=models.CharField(max_length=255)
    shippingCity=models.CharField(max_length=50, requiered=True)
    shippingCountry=models.CharField(max_length=50, requiered=True)
    currency=models.CharField(max_length=3)
    signature=models.CharField(max_length=255)
    tax=models.DecimalField(max_digits=14, decimal_places=2)
    taxReturnBase=models.DecimalField(max_digits=32, default=0)
    merchanID=models.IntegerField(max_length=12)
